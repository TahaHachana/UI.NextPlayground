(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Arrays,UINext,Bar,d3,IntrinsicFunctionProxy,UI,Next,Var1,Order,Var,View1,Doc,Html,List,Attr,T,Number,Trans,SvgElements,View,An,Interpolation,Easing,JQueryUI,SliderConfiguration,Slider,GoogleDashboard,Html1,Operators,Default,Hello,Scatter,Phoneword,Client,Gender,Unchecked,google,visualization,DataTable,Seq,document,PieChart,Table,Strings,String,Point,Key,Model1,Model,Collections,ResizeArray,ResizeArrayProxy,PointModel,setInterval,Math,Operators1;
 ...
 Runtime.OnInit(function()
 {
  ...
  UINext=Runtime.Safe(Global.UINext);
  Bar=Runtime.Safe(UINext.Bar);
  ...
  GoogleDashboard=Runtime.Safe(UINext.GoogleDashboard);
  Html1=Runtime.Safe(WebSharper.Html);
  Operators=Runtime.Safe(Html1.Operators);
  Default=Runtime.Safe(Html1.Default);
  Hello=Runtime.Safe(UINext.Hello);
  Scatter=Runtime.Safe(UINext.Scatter);
  Phoneword=Runtime.Safe(UINext.Phoneword);
  Client=Runtime.Safe(UINext.Client);
